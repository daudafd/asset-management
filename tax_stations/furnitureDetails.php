...
if(isset($_GET['assetApplicationNumber'])){
    ...
    $execQry = fetchSingleData("tbl_furnitures", "scan_code", $scan_code);
...
<!--/////////////////////////////////////Do your delete and edit here///////////////////////////////////-->
                        ...
                        <a id="backBtn" href="viewFurniture.php"
                        type="button" class="popUpModal mb-2 mr-2 btn-transition btn btn-outline-primary"><i
                            class="fa fa-arrow-alt-circle-left mr-3"></i>Back to Furniture List
                            </a>
                            <a href="editFurniture.php?scan_code=<?php echo $scan_code;?>"
                            type="button" class="popUpModal mb-2 mr-2 btn-transition btn btn-outline-success" id="application-print"><i
                            class=""></i>Edit Furniture Details
                            </a>
                            ...
                            <i class="fa fa-arrow-alt-circle-delete"></i>Delete Furniture List</button>
                        </div>
                        <hr style="border-top:1px dotted #ccc;"/>
...
/*///////////////////////////////// A call to function is done here//////////////////////////////////////*/
                        ...
                        <div class="table-responsive p-3">
                            <table class="table table-bordered table-striped">
                                <tr>
                                    ...
                                    <td style="width: 30%"><?php echo $rows['ff_sub_category'];?></td>
                    ...
                    <script src="js/deleteFurniture.js"></script> 

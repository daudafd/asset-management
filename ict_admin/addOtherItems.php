                            ...
                            <div class="page-title-wrapper">
                                <div class="page-title-heading">
                                    <div class="page-title-icon">
                                        <i class="pe-7s-scissors icon-gradient bg-mean-fruit">
                                        </i>
                                    </div>
                               ...
                               <!--/////////////////////////////////////////ELECTRICAL FORM STARTS HERE////////////////////////////////////-->
                                ...
                                <hr/>  
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <label for="buildingImage">Upload Other Items Image</label>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <label for="validationCustom02">Other Items Description</label>
                                ...
                                <?php include "addOtherItemsAjax.php"; ?>
                                ...
                                // Javascript responsible for loading various categories of asset
                                    $(document).ready(function() {
                                        ...
                                        $("#oi_category").change(function() {
                                            ...
                                            $.get('loadoisubcat.php?oi_category=' + $(this).val(), function(data) {

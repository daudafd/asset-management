...
asset_condition = '$oi_asset_condition', dept = '$dept', created_date = '$created_date' WHERE scan_code ='$scan_code' ";
...
brand = '$oi_brand', own_degree = '$oi_own_degree', status = '$oi_status',  description = '$oi_descriptn', 
asset_condition = '$oi_asset_condition', dept = '$dept', created_date = '$created_date' WHERE scan_code ='$scan_code' ";

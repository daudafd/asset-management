                         ...
                         <!--/////////////////////////////////////////VEHICLE FORM STARTS HERE////////////////////////////////////-->
                            ...
                            <!--/////////////////////////////////////////FURNITURE FORM STARTS HERE////////////////////////////////////-->
                               ...
                               <!--/////////////////////////////////////////ELECTRICAL FORM STARTS HERE////////////////////////////////////-->
                                ...
                                <div class="tab-pane active" id="tab-animated-4" role="tabpanel"><p class="mb-0">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="text" class="form-control" name = "serial_no"  id="serial_no" placeholder="Serial No"   required>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <label for="buildingImage">Upload Electronics Image</label>
                                ...
                                <?php include "addElectronicsAjax.php"; ?>
                                ...
                                // Javascript responsible for loading various categories of asset
                                    $(document).ready(function() {
                                        ...
                                        $("#ee_category").change(function() {
                                            ...
                                            $.get('loadeesubcat.php?ee_category=' + $(this).val(), function(data) {

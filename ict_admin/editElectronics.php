...
if(isset($_GET['scan_code'])){
    ...
    $execQry = fetchSingleData("tbl_electronics", "scan_code", $scan_code);
    $row = mysqli_fetch_array($execQry);
    $scan_code = $row['scan_code'];
    $ee_sub_category = $row['ee_sub_category'];
    $name = $row['name'];
    $brand = $row['brand'];
    $model = $row['model'];
...
<div class="scrollbar-container">
                    <div class="app-main__inner">
                        <div class="app-page-title">
                            ...
                            $ee_query_parent = mysqli_query($conn, "SELECT * FROM ee_category") or die("Query failed: ".mysqli_error());
                                        ...
                                        <div class="mb-3 card">
                                            <div class="card-body">
                                                <ul class="tabs-animated-shadow tabs-animated nav">
                                                    ...
                                                    <li class="nav-item">
                                                        <a role="tab" class="nav-link active" id="tab-c-2" data-toggle="tab" href="#tab-animated-4">
                        ...
                        <!--/////////////////////////////////BULDING FORM ENDS HERE////////////////////////////////////-->
                            ...
                            <!--/////////////////////////////////////////FURNITURE FORM STARTS HERE////////////////////////////////////-->
                               ...
                               <!--/////////////////////////////////////////ELECTRICAL FORM STARTS HERE////////////////////////////////////-->
                                ...
                                <div class="tab-pane active" id="tab-animated-4" role="tabpanel"><p class="mb-0">
                                    <hr/>  
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <select type="text" class="form-control" name= "ee_category" id="ee_category" required>
                                                            <option value="">Select Category</option>
                                                            <?php while($row = mysqli_fetch_array($ee_query_parent)): ?>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <select type="text" class="form-control" name = "ee_sub_category" id="ee_sub_category" required>
                                            <option value="<?php echo $ee_sub_category; ?>">
                                            <?php echo $ee_sub_category; ?></option>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="text" class="form-control" name = "dept" id="dept" value = "<?php echo $dept; ?>" placeholder="Department"  required readonly>
                                            <div class="invalid-feedback">Please provide a valid description</div>
                                        </div>
                                ...
                                <?php include "editElectronicsAjax.php"; ?>
                                <script>
                                ...
                                // Javascript responsible for loading various categories of asset
                                    $(document).ready(function() {
                                        ...
                                        // Javascript for ee_category is for asset vechicle
                                        $("#ee_category").change(function() {
                                            $(this).after('<div id="loader"><img src="img/loading.gif" alt="loading subcategory" /></div>');
                                            $.get('loadsubcat.php?ee_category=' + $(this).val(), function(data) {
                                                $("#ee_sub_category").html(data);

                         ...
                         <!--/////////////////////////////////////////VEHICLE FORM STARTS HERE////////////////////////////////////-->
                            ...
                            <form action = "" method = "POST" enctype="multipart/form-data"  onsubmit="return validateForm()" id = "assetRegistrationForm" class="needs-validation"  novalidate>
                                    <div class="form-row">
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <div class="invalid-feedback">Please provide a valid vehicle category</div>
                                        </div>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <div class="invalid-feedback">Please provide a valid building description</div>
                                        </div>

                                        <div class="col-md-4 mb-3">
                                            <label for="validationCustom01">Number Plate</label>
                                            <input type="text" class="form-control" name = "no_plate"  id="no_plate" placeholder="Number Plate"   required>
                                            
                                            <div class="invalid-feedback">Please provide a valid number plate</div>
                                        </div>
                                        <div class="col-md-4 mb-3">
                                            <label for="validationCustom02">Chasis Number</label>
                                            <input type="text" class="form-control" name = "chasis_no" id="chasis_no" placeholder="Chasis No: YH227272DDJGR7783"  required>
                                        ...
                                        <!--div class="col-md-4 mb-3">
                                            ...
                                            <input type="text" class="form-control" name = "dept" id="dept" placeholder="Department in Use"   required>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <select type="text" class="form-control" name = "dept" id="dept" required>
                                                            ...
                                                            <option value="PoolDrivers">Pool&Driver</option>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="text" class="form-control" name = "driver" id="driver" placeholder="Driver in Charge"   required>
                                            <div class="invalid-feedback">Please provide a valid department</div>
                                        </div>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="text" class="form-control" name = "year" id="year" placeholder="Production Year"   required>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <label for="buildingImage">Upload Vehicle Image</label>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <label for="validationCustom02">Vehicle Description</label>
                            ...
                            <!--/////////////////////////////////////////FURNITURE FORM STARTS HERE////////////////////////////////////-->
                               ...
                               <!--/////////////////////////////////////////ELECTRICAL FORM STARTS HERE////////////////////////////////////-->
                                ...
                                <?php include "addVehicleAjax.php"; ?>
                                ...
                                // Javascript responsible for loading various categories of asset
                                    $(document).ready(function() {
                                        ...
                                        $("#ve_category").change(function() {
                                            ...
                                            $.get('loadvesubcat.php?ve_category=' + $(this).val(), function(data) {

...
if(isset($_GET['scan_code'])){
    ...
    $ve_sub_category = $row['ve_sub_category'];
    $name = $row['name'];
...
<div class="scrollbar-container">
                    <div class="app-main__inner">
                        <div class="app-page-title">
                            ...
                            $ve_query_parent = mysqli_query($conn, "SELECT * FROM ve_category") or die("Query failed: ".mysqli_error());
                        ...
                        <!--/////////////////////////////////BULDING FORM ENDS HERE////////////////////////////////////-->
                            ...
                            <div class="tab-pane active" id="tab-animated-1" role="tabpanel"><p class="mb-0">
                                    <hr/>  
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <select type="text" class="form-control" name= "ve_category" id="ve_category" required>
                                                            <option value="">Select Category</option>
                                                            <?php while($row = mysqli_fetch_array($ve_query_parent)): ?>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <select type="text" class="form-control" name = "ve_sub_category" id="ve_sub_category" required>
                                            <option value="<?php echo $ve_sub_category; ?>">
                                            <?php echo $ve_sub_category; ?></option>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <label for="validationCustom01">Vehicle Location</label>
                                        ...
                                        <!--div class="col-md-4 mb-3">
                                            <label for="validationCustom02">Vehicle Location</label>
                                           
                                            <select name="location"  name = "location" id="location" class="form-control" disabled>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <label for="validationCustom01">Number Plate</label>
                                            <input type="text" class="form-control" name = "no_plate"  id="no_plate" value="<?php echo $no_plate; ?>" placeholder="Number Plate" required>
                                            <div class="invalid-feedback">Please provide a valid number plate</div>
                                        </div>
                                        <div class="col-md-4 mb-3">
                                            <label for="validationCustom02">Chasis Number</label>
                                            <input type="text" class="form-control" name = "chasis_no" id="chasis_no" value="<?php echo $chasis_no; ?>" placeholder="Chasis No: YH227272DDJGR7783"  required>
                                            <div class="invalid-feedback">Please provide a valid chasis no</div>
                                        </div>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <label for="validationCustom02">Vehicle Status</label>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <label for="validationCustom02">Vehicle Condition</label>
                                        ...
                                        <!--div class="col-md-4 mb-3">
                                            ...
                                            <input type="text" class="form-control" name = "dept" id="dept" value="<?php echo $dept; ?>" placeholder="Department in Use"   required>
                                            <div class="invalid-feedback">Please provide a valid department</div>
                                        </div-->

                                        <div class="col-md-4 mb-3">
                                            <label for="validationCustom02">Driver</label>
                                            <input type="text" class="form-control" name = "driver" id="driver" value="<?php echo $driver; ?>" placeholder="Driver in Charge"   required>
                                            <div class="invalid-feedback">Please provide a valid department</div>
                                        </div>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <label for="validationCustom02">Year of Production</label>
                                            <input type="text" class="form-control" name = "year" id="year" value="<?php echo $year; ?>" placeholder="Production Year"   required>
                            ...
                            <!--/////////////////////////////////////////FURNITURE FORM STARTS HERE////////////////////////////////////-->
                               ...
                               <!--/////////////////////////////////////////ELECTRICAL FORM STARTS HERE////////////////////////////////////-->
                                ...
                                <?php include "editVehicleAjax.php"; ?>
                                ...
                                // Javascript responsible for loading various categories of asset
                                    $(document).ready(function() {
                                        ...
                                        // Javascript for v_category is for asset vechicle
                                        $("#ve_category").change(function() {
                                            $(this).after('<div id="loader"><img src="img/loading.gif" alt="loading subcategory" /></div>');
                                            $.get('loadsubcat.php?ve_category=' + $(this).val(), function(data) {
                                                $("#ve_sub_category").html(data);

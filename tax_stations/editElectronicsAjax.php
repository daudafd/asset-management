...
$ee_sub_category = trim($_POST['ee_sub_category']);
...
//$exeQuery = "";
$sql = "UPDATE tbl_electronics SET  ee_sub_category = '$ee_sub_category', name = '$name', serial_no = '$serial_no', model = '$model',
...
quantity = '$quantity',  descriptn = '$descriptn', created_date = '$created_date' WHERE scan_code ='$scan_code' ";
$exeQuery = mysqli_query($conn, $sql);

$sql2 = "UPDATE allasset SET  sub_category = '$ee_sub_category', name = '$name', serial_number = '$serial_no', model = '$model',
brand = '$brand', location = '$location', own_degree = '$own_degree', status = '$status', asset_condition = '$asset_condition',
initial_value = '$initial_value', procure_date = '$procure_date', deprec_value = '$deprec_value', address = '$address', size = '$size',
quantity = '$quantity',   description = '$descriptn', created_date = '$created_date' WHERE scan_code ='$scan_code' ";

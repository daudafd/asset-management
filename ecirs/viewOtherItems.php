...
$asstQry = fetchAllAsset('tbl_otheritems','scan_code');
?>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="main-card mb-8 card">
                                    <div class="card-body"><h5 class="card-title">Other Items</h5>
                                    <div class="table-responsive">
                                        <table class="mb-0 table table-hover" id="dataTable">
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $rows['oi_sub_category']?></td>
                                                <td><?php echo $rows['location'];?></td>
                                                <td><a href="otherItemsDetails.php?assetApplicationNumber=<?php echo $rows['scan_code'];?>"><type="button" class="popUpModal mb-2 mr-2 btn-transition btn btn-outline-primary">Asset Details</a></td>
                                            </tr>
                                                <?php } ?>

...
<!--/////////////////////////////////////Do your delete and edit here///////////////////////////////////-->
                        ...
                        type="button" class="popUpModal mb-2 mr-2 btn-transition btn btn-outline-primary"><i
                            ...
                            <i class="fa fa-arrow-alt-circle-delete"></i>Delete Building List</button>
                        </div>
                        <hr style="border-top:1px dotted #ccc;"/>
...
/*///////////////////////////////// A call to function is done here//////////////////////////////////////*/
                            ...
                            <div class="col-lg-8 col-md-8">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <lebel><b>Asset Condition:</b></lebel>
                                        </div>
                                        <div class="col-sm-8">
                                            <span><?php echo $rows['asset_condition'];?></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                        ...
                        <div class="table-responsive p-3">
                            <table class="table table-bordered table-striped">
                                <tr>
                                    ...
                                    <td style="width: 30%"><?php echo $rows['bu_sub_category'];?></td>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 30%"><?php echo $rows['model']."".$rows['e_model'];?></td>
                                </tr-->
                            </table>
                        </div>
                      </div><hr>
                    ...
                    <script src="../js/deleteBuilding.js"></script> 

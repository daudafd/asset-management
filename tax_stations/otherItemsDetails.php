...
<!--/////////////////////////////////////Do your delete and edit here///////////////////////////////////-->
                        ...
                        type="button" class="popUpModal mb-2 mr-2 btn-transition btn btn-outline-primary"><i
                            class="fa fa-arrow-alt-circle-left mr-3"></i>Back to Other Items List
                            </a>
                            <a href="editOtherItems.php?scan_code=<?php echo $scan_code;?>"
                            type="button" class="popUpModal mb-2 mr-2 btn-transition btn btn-outline-success" id="application-print"><i
                            class=""></i>Edit Other Items
                            </a>
                            ...
                            <i class="fa fa-arrow-alt-circle-delete"></i>Delete Other Items List</button>
                        </div>
                        <hr style="border-top:1px dotted #ccc;"/>
...
/*///////////////////////////////// A call to function is done here//////////////////////////////////////*/
                        ...
                        <div class="table-responsive p-3">
                            <table class="table table-bordered table-striped">
                                <tr>
                                    ...
                                    <td style="width: 30%"><?php echo $rows['oi_sub_category'];?></td>
                    ...
                    <script src="js/deleteOtherItems.js"></script> 

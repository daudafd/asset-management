...
deprec_value = '$deprec_value', address = '$address', size = '$size', quantity = '$quantity',  descriptn = '$descriptn', 
...
status = '$status', asset_condition = '$asset_condition', initial_value = '$initial_value', procure_date = '$procure_date',
deprec_value = '$deprec_value', address = '$address', size = '$size', quantity = '$quantity',   description = '$descriptn', 
created_date = '$created_date' WHERE scan_code ='$scan_code' ";

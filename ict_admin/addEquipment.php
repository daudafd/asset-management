                            ...
                            <!--/////////////////////////////////////////FURNITURE FORM STARTS HERE////////////////////////////////////-->
                                ...
                                <div class="tab-pane active" id="tab-animated-3" role="tabpanel"> <p class="mb-0">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <label for="validationCustom02">Equipment Address</label>
                                            <input type="text" class="form-control" name = "address" id="address" placeholder="Address"   required>
                                            <div class="invalid-feedback">Please provide a valid description</div>
                                        </div>

                                        <div class="col-md-4 mb-3">
                                            <label for="validationCustom02">Equipment Size</label>
                                            <input type="text" class="form-control" name = "size" id="size" placeholder="Size"   required>
                                            <div class="invalid-feedback">Please provide a valid description</div>
                                        </div>

                                        <div class="col-md-4 mb-3">
                                            <label for="validationCustom02">Equipment Quantity</label>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <label for="buildingImage">Upload Equipment Image</label>
                               ...
                               <!--/////////////////////////////////////////ELECTRICAL FORM STARTS HERE////////////////////////////////////-->
                                ...
                                <?php include "addEquipmentAjax.php"; ?>
                                ...
                                // Javascript responsible for loading various categories of asset
                                    $(document).ready(function() {
                                        ...
                                        $("#eq_category").change(function() {
                                            ...
                                            $.get('loadeqsubcat.php?eq_category=' + $(this).val(), function(data) {

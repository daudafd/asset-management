                        ...
                        <div class="app-page-title">
                            <div class="page-title-wrapper">
                                <div class="page-title-heading">
                                    ...
                                    <?php include('includes/electronics_dashboard.php');?>
...
<!--/////////////////////////////////////Do your delete and edit here///////////////////////////////////-->
                        ...
                        type="button" class="popUpModal mb-2 mr-2 btn-transition btn btn-outline-primary"><i
                            class="fa fa-arrow-alt-circle-left mr-3"></i>Back to Electronics List
                            </a>
                            <a href="editElectronics.php?scan_code=<?php echo $scan_code;?>"
                            type="button" class="popUpModal mb-2 mr-2 btn-transition btn btn-outline-success" id="application-print"><i
                            class=""></i>Edit Electronics Details
                            </a>
                            ...
                            <i class="fa fa-arrow-alt-circle-delete"></i>Delete Electronics List</button>
                        </div>
                        <hr style="border-top:1px dotted #ccc;"/>
...
/*///////////////////////////////// A call to function is done here//////////////////////////////////////*/
                        ...
                        <div class="table-responsive p-3">
                            <table class="table table-bordered table-striped">
                                ...
                                <tr>
                                    ...
                                    <td style="width: 30%"><?php echo $rows['address'];?></td>
                                    <th style="width: 20%">Size :</th>
                                    <td style="width: 30%"><?php echo $rows['size'];?></td>
                                </tr>

                                <tr>
                                    <th style="width: 20%">Quantity :</th>
                                    <td style="width: 30%"><?php echo $rows['quantity'];?></td>
                                    <th style="width: 20%">Department :</th>
                                    <td style="width: 30%"><?php echo $rows['dept'];?></td>
                                </tr>
                            </table>
                        </div>
                      </div><hr>
                    ...
                    <script src="js/deleteElectronics.js"></script> 
                    ...
                    <div class="col-12 grid-margin">
                        ...
                        <div class="row">
                            <div class="col-md-12 text-center">
                                <p><b>Sorry! You cannot delete this asset. Contact the system administrator for further assistance.</b></p>
                            </div>
                        ...
                        <div class="row text-center">
                            <div class="col-md-12">
                                <!--button class="btn btn-info mr-2" id="sra-btn">Delete</button-->
                                <button data-dismiss="modal" type="button" class="popUpModal mb-2 mr-2 btn-transition btn btn-outline-danger" id="btn-cancel">Cancel</button>
                            </div>

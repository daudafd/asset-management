                        ...
                        <div class="app-page-title">
                            <div class="page-title-wrapper">
                                <div class="page-title-heading">
                                    ...
                                    <?php include('includes/equipment_dashboard.php');?>
...
<!--/////////////////////////////////////Do your delete and edit here///////////////////////////////////-->
                        ...
                        type="button" class="popUpModal mb-2 mr-2 btn-transition btn btn-outline-primary"><i
                            class="fa fa-arrow-alt-circle-left mr-3"></i>Back to Equipment List
                            </a>
                            <a href="editEquipment.php?scan_code=<?php echo $scan_code;?>"
                            type="button" class="popUpModal mb-2 mr-2 btn-transition btn btn-outline-success" id="application-print"><i
                            class=""></i>Edit Equipment Details
                            </a>
                            ...
                            <i class="fa fa-arrow-alt-circle-delete"></i>Delete Equipment List</button>
                        </div>
                        <hr style="border-top:1px dotted #ccc;"/>
...
/*///////////////////////////////// A call to function is done here//////////////////////////////////////*/
                        ...
                        <div class="table-responsive p-3">
                            <table class="table table-bordered table-striped">
                                <tr>
                                    ...
                                    <td style="width: 30%"><?php echo $rows['eq_sub_category'];?></td>
                    ...
                    <script src="js/deleteEquipment.js"></script> 
